...
public:
    ...
    void AddEq(IdList<Equation> *l, Expr *expr, int index) const;
    void GenerateEquations(IdList<Equation> *l) const;
};
...
public:
    ...
    void MakeLatheCircles(IdList<Entity> *el, IdList<Param> *param, hEntity in, Vector pt, Vector axis);
    void MakeLatheSurfacesSelectable(IdList<Entity> *el, hEntity in, Vector axis);
    void MakeRevolveEndFaces(IdList<Entity> *el, hEntity pt, int ai, int af);
    ...
    void AddEq(IdList<Equation> *l, Expr *expr, int index);
...
public:
    ...
    void Generate(IdList<Param> *param);

    void GenerateEquations(IdList<Equation> *entity,
                           bool forReference = false) const;
    // Some helpers when generating symbolic constraint equations
    void ModifyToSatisfy();
    void AddEq(IdList<Equation> *l, Expr *expr, int index) const;
    void AddEq(IdList<Equation> *l, const ExprVector &v, int baseIndex = 0) const;
